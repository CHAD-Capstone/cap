...
class AprilTagLocalizationNode:
    ...
    def load_apriltag_map(self, msg=None):
        try:
            if self.use_approximate_map:
                self.logwarn("USING APPROXIMATE TAG MAP!!")
    ...
    def take_and_process_img(self):
        ...
        for detected_tag_id, detected_tag_corners in tags.items():
            ...
            estimated_marker_pose_params = matrix_to_params(estimated_poses, type="quaternion")
        ...
        while not rospy.is_shutdown():
            ...
            if len(tag_poses) > 0:
                ...
                for tag_id, tag_pose in tag_poses:
                    ...
                    transform_stamped.transform.rotation.x = tag_pose[4]
                    transform_stamped.transform.rotation.x = tag_pose[5]
                    transform_stamped.transform.rotation.x = tag_pose[6]
